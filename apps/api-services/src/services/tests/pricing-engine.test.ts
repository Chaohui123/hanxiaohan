...
describe("PricingEngine", () => {
  ...
  it("calculates price with competitors", () => {
    const result = engine.calculatePrice(10, 12, [
      { sourceUrl: "", productId: 1, priceRub: 500, rating: 4, reviewCount: 10, salesVolume: 100, title: "C1" },
    ]);
  ...
  it("applies desired position leader", () => {
    const r1 = engine.calculatePrice(10, 12, [{ sourceUrl: "", productId: 1, priceRub: 200, rating: 4, reviewCount: 10, salesVolume: 100, title: "C" }], { desiredPosition: "leader" });
    expect(r1.pricePosition).toBeDefined();
  });

  it("applies premium position", () => {
    const r = engine.calculatePrice(50, 12, [{ sourceUrl: "", productId: 1, priceRub: 5000, rating: 5, reviewCount: 100, salesVolume: 500, title: "P" }], { desiredPosition: "premium" });
