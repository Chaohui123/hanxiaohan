...
2. 描述（description_ru）：
   ...
   - 使用客观、信息性的俄语电商表达（不得使用催促/稀缺性话术，见合规要求）
...
6. 禁止未授权品牌声明：оригинал, подлинный (除非有品牌授权)；描述兼容性用 "аналог", "подходит для", "совместимый с"，避免 "оригинальный/оригинальная" 等"原厂"形容词（有侵权判定风险）
