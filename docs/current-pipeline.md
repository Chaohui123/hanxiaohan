...
| MAR-BAITBOAT-01 | 6022474348 / 5522804641 | 智能打窝船 V803（500m 遥控/5200mAh/3kg 料仓） | 402¥ | **8/19 上架在售**（28 天榜单 ~380 件/600 万₽ 全铺货无品牌），1033.4¥/12990₽，破零价 11990₽，库存 10，净利 35.7%（含锂电物流 700₽ 口径，首单后回填实际账单） |
...
- **双底线（不破底价绝不调）**：底价 = max（毛利率 20% 线 `成本₽/0.80`，净利率 10% 线 `(成本₽+物流300₽)/0.70`）——净利口径含佣金 20%+CEL 物流 300₽/单。**不亏本卖**是铁律
